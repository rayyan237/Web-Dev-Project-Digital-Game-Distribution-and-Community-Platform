    ...
    <nav class="navbar navbar-expand-lg navbar-upper-border">
        ...
        <div class="container px-3 d-flex justify-content-start align-items-center flex-wrap flex-lg-nowrap">
            ...
            <div class="collapse navbar-collapse" id="upperNav">
                ...
                <div class="d-flex align-items-center gap-2 d-lg-flex d-none" id="desktopAuthButtons">
                ...
                <div class="d-flex flex-column align-items-stretch gap-2 d-lg-none border-top border-secondary pt-3 mt-3 mx-2" id="mobileAuthButtons">
...
<nav class="secondary-navbar py-2" aria-label="Secondary Navigation">
    <div class="container d-flex align-items-center">
        ...
        <form class="header-search-group desktop-search-form d-none d-lg-flex input-group" role="search" aria-label="Desktop Search" action="games-list.php" method="get">
            <input class="header-search-input form-control" type="search" placeholder="Search" name="q"
                aria-label="Search">
            <button class="header-search-btn btn d-flex align-items-center justify-content-center" type="submit"
                aria-label="Search">
